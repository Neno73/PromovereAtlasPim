...
export interface ApiProductVariantProductVariant
  ...
  attributes: {
    ...
    production_time: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    customs_tariff_number: Schema.Attribute.String &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 20;
      }>;
...
export interface ApiSyncConfigurationSyncConfiguration
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    products_created: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    products_processed: Schema.Attribute.Integer &
      Schema.Attribute.DefaultTo<0>;
    products_updated: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    supplier: Schema.Attribute.Relation<'oneToOne', 'api::supplier.supplier'>;
